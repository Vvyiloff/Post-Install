...
### From release:
1. Download `Software-Installer-2.0.4-Setup.exe` from [Releases](https://github.com/Vvyiloff/Post-Install/releases)
2. Run the installer

Or download the portable version `Software-Installer-Electron-v2.0.4.zip`
